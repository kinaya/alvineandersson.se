  ...
  return (
    <div className="container services">
        ...
        <div className="wrapper">
          ...
          <Service id="accessibility" headline="Tillgänglig webb" text="Webb tillgänglig för alla, både i kod, form och innehåll. Webb som funkar lika bra på desktop, mobil och smartTv, eller med skärmläsare och röststyrning." />
        </div>
			</div>
    </div>
  );
